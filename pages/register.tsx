    ...
    <div className='ml-4 py-4 px-2 space-y-2'>
      ...
      <form action="/api/register" method="post" className='space-y-3'>
        ...
        <div>
          ...
          <label htmlFor="tos">
            I acknowledge that these services are offered with no guarantee, and we reserve the right
            to cut your lock at any time. If we cut your lock, we will keep your locker contents for
            a few months.
          </label>
        </div>
